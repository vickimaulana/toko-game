			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mt-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<h6 class="text-muted">Edisi <?= ucfirst($game['edition']) ?></h6>
						<h3 class="text-right text-warning price mt-4">Rp<?= number_format($game['price'], 2, ',', '.'); ?></h3>
						<a href="<?= base_url('home/detail/' . $game['id']) ?>" class="btn btn-outline-info btn-sm btn-block mt-3">Lihat Lebih Banyak</a>
					</div>
				</div>
			</div>
		<?php endforeach; ?>
