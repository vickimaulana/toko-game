<div class="container">
	...
	<div class="row mt-5">
		...
		<div class="col-5">
			...
			<h4 class="font-weight-normal">Edisi <?= ucfirst($game['edition']) ?></h4>
			<br> <br>
			<p><?= character_limiter($game['description'], 200) ?></p>
			<a href="#description" class="text-info font-weight-bold">Lihat Lebih Banyak</a>
			<br> <br>
			<p class="font-weight-bold">EDISI</p>
			...
			<div class="card">
				<div class="card-body text-center">
					...
					<form action="<?= base_url('cart/add') ?>" method="POST">
						...
						<button type="submit" class="btn btn-large btn-success btn-block badge-pill mb-4">Masukkan Ke Keranjang</button>
					</form>
				</div>
			</div>
		</div>
