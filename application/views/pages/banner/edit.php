<div class="container">
  <div class="row mt-4">
    <div class="col">
      <h2 class="text-center">Perbarui Banner</h2>
    </div>
  </div>
  ...
  <div class="row bg-light p-3 mt-4">
    <div class="col">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label font-weight-bold">Kepala Banner</label>
        <div class="col-sm-10">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label font-weight-bold">Warna Teks</label>
        <div class="col-sm-10">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label font-weight-bold">Game Terkait</label>
        <div class="col-sm-10">
