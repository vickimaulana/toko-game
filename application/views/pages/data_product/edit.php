<div class="container">
	<div class="row mt-4">
		<div class="col">
			<h2 class="text-center">Perbarui Game</h2>
		</div>
	</div>
	...
	<div class="row bg-light p-3 mt-4">
		<div class="col">
			...
			<?= form_open_multipart(base_url('data_product/edit/' . $product['id'])) ?>
				...
				<div class="col-5">
					<div class="form-group">
						...
						<select class="form-control" name="edition">
							<option value="reguler" <?php if ($product['edition'] == "reguler") {
																				print ' selected';
																			} ?>>Reguler</option>
							<option value="premium" <?php if ($product['edition'] == "premium") {
																				print ' selected';
																			} ?>>Premium</option>
						</select>
					</div>
